            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
                    <div className="col-span-2 space-y-3">
                        ...
                        <p className="text-gray-400">Join us to make your car rental experience seamless and enjoyable. We offer unparalleled service and a wide selection of vehicles to meet all your needs.
